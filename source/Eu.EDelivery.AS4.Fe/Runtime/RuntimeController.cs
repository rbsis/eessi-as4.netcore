...
public class RuntimeController
{
    ...
    [HttpGet]
    [Route("getreceivers")]
    [SwaggerResponse((int)HttpStatusCode.OK, "Receivers retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [HttpGet]
    [Route("getsteps")]
    [SwaggerResponse((int)HttpStatusCode.OK, "Steps retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Transformers retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Certificate repositories retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Deliver senders retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Attachment uploaders retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Dynamic discovery profiles retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Notify senders retrieved successfully", typeof(IEnumerable<ItemType>))]
    ...
    [Route("getall")]
    [AllowAnonymous]
    [SwaggerResponse((int)HttpStatusCode.OK, "All runtime types retrieved successfully", typeof(OkResult))]
    ...
    [SwaggerResponse((int)HttpStatusCode.OK, "Runtime metadata retrieved successfully", typeof(OkResult))]
