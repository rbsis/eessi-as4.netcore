...
public class GivenSignStrategyFacts
{
    ...
    {
        // Arrange
        var signingStrategy = CreateSignStrategyForSigning();
        ...
        var signedInfoReferences = signatureElement.SelectEbmsNodes("/dsig:SignedInfo/dsig:Reference");
        Assert.True(
        ...
        var keyInfoReferences = signatureElement.SelectEbmsNodes("/dsig:KeyInfo/wsse:SecurityTokenReference/wsse:Reference");
        Assert.True(
