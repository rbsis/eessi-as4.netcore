...
public class GivenAS4EncryptedKeyFacts
{
    public class GivenValidArguments : GivenAS4EncryptedKeyFacts
    {
        ...
        public void ThenGetReferenceIdSucceeds(string id)
        {
            ...
            // Act
            var referenceId = as4EncryptedKey.GetReferenceId();
        ...
        public void ThenAppendEncryptedKeySucceeds()
        {
            ...
            var securityElement = xmlDocument.CreateElement(
                "wsse",
                "Security",
            ...
            // Assert
            Assert.NotNull(securityElement.FirstChild);
        ...
        {
            // Arrange
            var cipherData = new CipherData { CipherValue = [20] };
            var encryptedKey = new EncryptedKey { CipherData = cipherData };

            var as4EncryptedKey = AS4EncryptedKey.FromEncryptedKey(encryptedKey);

            // Act
            var as4CipherData = as4EncryptedKey.GetCipherData();
...
public class AS4EncryptedKeyBuilderFacts
{
    ...
    {
        using var generator = Aes.Create();
