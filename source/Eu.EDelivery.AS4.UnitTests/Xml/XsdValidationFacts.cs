...
public class XsdValidationFacts : IClassFixture<XsdValidationFixture>
{
    ...
    protected static IEnumerable<string> VerifySendingPMode(string sendingPModeFile)
    {
    ...
    protected static IEnumerable<string> VerifyReceivingPMode(string receivingPModeFile)
    {
    ...
    protected static IEnumerable<string> VerifySubmitMessage(string submitMessage)
    {
