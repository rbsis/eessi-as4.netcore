...
public class GivenMessagingContextFacts
{
    ...
    public class GivenValidArguments : GivenMessagingContextFacts
    {
        ...
        {
            // Arrange
            var filledNotify = new NotifyMessageEnvelope(new AS4.Model.Notify.MessageInfo(), Status.Delivered, [], "type", typeof(InMessage));
            ...
            var anonymousNotify = new NotifyMessageEnvelope(new AS4.Model.Notify.MessageInfo(), default, [], "", typeof(InMessage));
        ...
        {
            // Arrange
            var filledNotify = new DeliverMessageEnvelope(new MessageInfo(), [], "type");
            var context = new MessagingContext(filledNotify)
            {
                SendingPMode = new SendingProcessingMode(),
                ReceivingPMode = new ReceivingProcessingMode()
            ...
            var anonymousDeliver = new DeliverMessageEnvelope(new MessageInfo(), [], "type");
        ...
        public void ThenGettingMessageIdsSucceeds()
        {
            ...
            var as4Message = AS4Message.Create(new UserMessage(messageId));
            var context = new MessagingContext(as4Message, MessagingContextMode.Unknown);

            // Act
            var messageIds = context.AS4Message?.MessageIds;
        ...
        public void ThenHasAttachmentsIsCorrectFalse()
        {
            ...
            // Act
            var hasAttachments = context.AS4Message!.HasAttachments;
        ...
        public void ThenHasPayloadsIsCorrectFalse()
        {
            ...
            // Act
            var hasPayloads = internalMessage.SubmitMessage!.HasPayloads;
        ...
        {
            // Arrange
            var submitMessage = new SubmitMessage { Payloads = [new Payload(string.Empty)] };
            var internalMessage = new MessagingContext(submitMessage);
        ...
        public void ThenMessagingContextHasEbmsIdFromSignalMessage()
        {
            ...
            // Act
            var prefix = context.EbmsMessageId;
