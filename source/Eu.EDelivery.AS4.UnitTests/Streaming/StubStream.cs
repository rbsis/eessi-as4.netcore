...
public class StubStream : Stream
{
    ...
    /// </summary>
    /// <exception cref="T:System.IO.IOException">An I/O error occurs. </exception>
    public override void Flush() => _imp.Flush();
    ...
    /// <exception cref="T:System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
    public override int Read(byte[] buffer, int offset, int count) => _imp.Read(buffer, offset, count);
    ...
    /// </exception>
    /// <exception cref="T:System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
    public override long Seek(long offset, SeekOrigin origin) => _imp.Seek(offset, origin);
    ...
    /// </exception>
    /// <exception cref="T:System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
    public override void SetLength(long value) => _imp.SetLength(value);
    ...
    /// closed.
    /// </exception>
    public override void Write(byte[] buffer, int offset, int count) => _imp.Write(buffer, offset, count);

    protected override void Dispose(bool disposing) => _imp.Dispose();

    public override ValueTask DisposeAsync() => _imp.DisposeAsync();
}
