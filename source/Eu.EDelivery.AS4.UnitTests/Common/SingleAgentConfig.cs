...
public class SingleAgentConfig : PseudoConfig
{
    ...
    {
        Type = typeof(SaboteurTransformer).AssemblyQualifiedName
    };
    ...
    public override TimeSpan RetentionPeriod => default;
    ...
    /// </summary>
    public override TimeSpan RetryPollingInterval => default;
    ...
    public override IEnumerable<AgentConfig> GetAgentsConfiguration()
    {
        ...
        yield return new AgentConfig("test") { Settings = settings };
    }
