...
public class StepResult
{
    ...
    /// </summary>
    public IEnumerable<JournalLogEntry> Journal => _journal.AsEnumerable();
    ...
    {
        return new StepResult(Succeeded, CanProceed, MessagingContext, _journal.Concat([entry]));
    }
    ...
    /// </summary>
    /// <param name="entry">The entry containing information about the message.</param>
    public Task<StepResult> WithJournalAsync(JournalLogEntry entry) => Task.FromResult(WithJournal(entry));

    /// <summary>
    /// Promote the <see cref="StepResult"/> to stop the execution.
    /// </summary>
    /// <returns></returns>
    public StepResult AndStopExecution() => new(Succeeded, canProceed: false, context: MessagingContext);
    ...
    /// <returns></returns>
    public static StepResult Failed(MessagingContext context) => new(succeeded: false, canProceed: false, context: context);
    ...
    /// <param name="context">The <see cref="MessagingContext"/>.</param>
    /// <returns></returns>
    public static StepResult Success(MessagingContext context) => new(succeeded: true, canProceed: true, context: context);
    ...
    /// <param name="context">The <see cref="MessagingContext"/>.</param>
    /// <returns></returns>
    public static Task<StepResult> SuccessAsync(MessagingContext context) => Task.FromResult(Success(context));
    ...
    /// <param name="context">The <see cref="MessagingContext"/>.</param>
    /// <returns></returns>
    public static Task<StepResult> FailedAsync(MessagingContext context) => Task.FromResult(Failed(context));
}
