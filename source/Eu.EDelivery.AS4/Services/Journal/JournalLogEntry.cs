...
public class JournalLogEntry
{
    ...
    public void AddAgentLocation(AgentConfig a)
    {
        AgentName = a.Name;
        AgentType = a.Type;
    }
    ...
    /// Adds the agent location on which the message was processed.
    /// </summary>
    /// <param name="name">The name of the agent on which the message was processed.</param>
    /// <param name="type">the type of the agent on which the message was processed.</param>
    public void AddAgentLocation(string name, AgentType type)
    {
        AgentName = name;
        AgentType = type;
    }
