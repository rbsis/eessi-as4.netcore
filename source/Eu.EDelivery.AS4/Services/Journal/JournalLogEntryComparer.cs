...
{
    public static readonly IEqualityComparer<JournalLogEntry> ByEbmsMessageId = new JournalLogEntryComparer();
    ...
    /// </summary>
    /// <param name="x">The first object of type <see cref="JournalLogEntry" /> to compare.</param>
    /// <param name="y">The second object of type <see cref="JournalLogEntry" /> to compare.</param>
    ...
    public int GetHashCode(JournalLogEntry obj) => obj.GetHashCode();
}
