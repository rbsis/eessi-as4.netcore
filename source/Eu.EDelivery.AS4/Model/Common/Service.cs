...
public sealed class Service : IEquatable<Service>, IEqualityComparer<Service>
{
    ...
    public bool Equals(Service? x, Service? y) => x?.Equals(y) == true;
    ...
    public int GetHashCode([DisallowNull] Service obj) => obj.GetHashCode();
}
