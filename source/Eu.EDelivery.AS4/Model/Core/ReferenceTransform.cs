...
public sealed class ReferenceTransform : IEquatable<ReferenceTransform>
{
    ...
    public static bool operator ==(ReferenceTransform left, ReferenceTransform right) => Equals(left, right);
