...
public sealed class AgreementReference : IEquatable<AgreementReference>
{
    /// <summary>
    ...
    public override int GetHashCode() => HashCode.Combine(Value, Type, PModeId);
    ...
    public static bool operator ==(AgreementReference left, AgreementReference right) => Equals(left, right);
    ...
    public override string ToString()
    {
        ...
        var pmodeId = PModeId.Select(x => ", PModeId = " + x).GetOrElse(string.Empty);
