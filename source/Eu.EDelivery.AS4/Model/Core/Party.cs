...
public sealed class Party : IEquatable<Party>
{
    ...
    /// </summary>
    public static readonly Party DefaultFrom = new(EbmsDefaultRole, new PartyId(EbmsDefaultFrom));

    /// <summary>
    /// Gets the default 'To' party with the default role and party identifier for a receiving party.
    /// </summary>
    public static readonly Party DefaultTo = new(EbmsDefaultRole, new PartyId(EbmsDefaultTo));
    ...
    public Party(string role, PartyId partyId) : this(role, [partyId]) { }
    ...
    public string PrimaryPartyId => PartyIds.First().Id;
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            var hashRole = StringComparer.OrdinalIgnoreCase.GetHashCode(Role);
