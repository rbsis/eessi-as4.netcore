...
public class UserMessage : MessageUnit
{
    ...
    public UserMessage(string messageId)
        : this(messageId, Constants.Namespaces.EbmsDefaultMpc, CollaborationInfo.DefaultTest, Party.DefaultFrom, Party.DefaultTo, [], [])
    { }
    ...
    internal UserMessage(string messageId, CollaborationInfo collaboration)
        : this(messageId, collaboration, Party.DefaultFrom, Party.DefaultTo, [], []) { }
    ...
    internal UserMessage(string messageId, Party sender, Party receiver)
        : this(messageId, CollaborationInfo.DefaultTest, sender, receiver, [], [])
    { }
    ...
    internal UserMessage(string messageId, PartInfo part)
        : this(messageId, CollaborationInfo.DefaultTest, Party.DefaultFrom, Party.DefaultTo, [part], []) { }
