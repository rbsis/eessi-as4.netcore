...
/// </summary>
public sealed class CollaborationInfo : IEquatable<CollaborationInfo>
{
    /// <summary>
    ...
    public CollaborationInfo(AgreementReference agreement) : this(
        agreement: agreement,
    ...
    internal CollaborationInfo(Service service) : this(
        Maybe<AgreementReference>.Nothing,
        service,
        Constants.Namespaces.TestAction,
        DefaultConversationId)
    ...
    {
        AgreementReference = (agreement is not null).ThenMaybe(agreement!);
        Service = service;
        Action = action;
    ...
    {
        return HashCode.Combine(AgreementReference, Service, Action, ConversationId);
    }
    ...
    public static bool operator ==(CollaborationInfo left, CollaborationInfo right) => Equals(left, right);
