...
public sealed class PartInfo : IEquatable<PartInfo>
{
    /// <summary>
    ...
    /// </summary>
    public PartInfo(string href) : this(href, new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase), []) { }
    ...
    public static bool operator ==(PartInfo left, PartInfo right) => Equals(left, right);
