...
public class Encryption
{
    ...
    /// </summary>
    [XmlIgnore]
    public static readonly Encryption Default = new();
...
public class KeyEncryption
{
    ...
    /// </summary>
    public static readonly KeyEncryption Default = new();
