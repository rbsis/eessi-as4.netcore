...
public class SigningVerification
{
    ...
    private bool? _allowExpiredCertificate;
    ...
    [Info("Allow expired certificates")]
    [Description("When enabled, signature verification will not fail if the certificate is expired. The default value is false.")]
    public bool AllowExpiredCertificate
    {
        get => _allowExpiredCertificate ?? false;
        set => _allowExpiredCertificate = value;
    }
    ...
    [XmlIgnore]
    [JsonIgnore]
    public bool AllowExpiredCertificateSpecified => _allowExpiredCertificate.HasValue;
