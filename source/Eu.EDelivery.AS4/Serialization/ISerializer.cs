...
public interface ISerializer
{
    ...
    /// 
    void Serialize(AS4Message message, Stream output);
    ...
    Task SerializeAsync(AS4Message message, Stream output, CancellationToken cancellation);
    ...
    Task<AS4Message> DeserializeAsync(Stream? input, string contentType, CancellationToken cancellation);
}
