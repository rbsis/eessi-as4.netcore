...
partial class SoapEnvelopeSerializer
{
    ...
    {
        private static readonly Dictionary<SoapNamespace, XmlQualifiedName> _namespaceInformation = new()
        {
        ...
        private static readonly XmlSerializerNamespaces XmlSerializerNamespaceInfo = new([.. _namespaceInformation.Values]);
        ...
        public SoapEnvelopeBuilder(XmlDocument? envelopeDocument)
        {
            ...
            {
                var soapNamespace = _namespaceInformation[SoapNamespace.Soap];
        ...
        {
            ArgumentNullException.ThrowIfNull(messagingHeader);
        ...
        {
            ArgumentNullException.ThrowIfNull(securityHeader);
        ...
        public SoapEnvelopeBuilder SetToHeader(To to)
        {
            ...
            var roleAttribute = _document.CreateAttribute(soapNamespace.Name, "role", soapNamespace.Namespace);
        ...
        private XmlElement CreateElement(SoapNamespace namespaceInfo, string elementName)
        {
            return _document.CreateElement(
                prefix: _namespaceInformation[namespaceInfo].Name,
                localName: elementName,
                namespaceURI: _namespaceInformation[namespaceInfo].Namespace);
        }
        ...
        public XmlDocument Build()
        {
            ...
            nsMgr.AddNamespace("soap", _namespaceInformation[SoapNamespace.Soap].Namespace);
            nsMgr.AddNamespace("wsse", _namespaceInformation[SoapNamespace.SecurityExt].Namespace);
