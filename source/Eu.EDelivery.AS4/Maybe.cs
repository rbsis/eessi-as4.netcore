...
[DebuggerStepThrough]
public sealed class Maybe<TA> : IEquatable<Maybe<TA>>
{
    ...
    public static Maybe<TA> Nothing => new();
    ...
    /// <param name="x">The x.</param>
    /// <returns></returns>
    public static Maybe<T> Just<T>(T x) => new(x);
    ...
    public static bool operator ==(Maybe<TA> x, Maybe<TA> y) => Equals(x, y);
...
public static class MaybeEx
{
    ...
    /// <param name="x">The x.</param>
    /// <returns></returns>
    public static Maybe<TA> AsMaybe<TA>(this TA? x) => x is null ? Maybe<TA>.Nothing : Maybe<TA>.Just(x);
...
public static class MaybePreludeEx
{
    ...
    /// <returns></returns>
    public static Maybe<short> TryParseShort(this string str) => short.TryParse(str, out var sho).ThenMaybe(sho);
    ...
    /// <returns></returns>
    public static Maybe<byte> TryParseByte(this string s) => byte.TryParse(s, out var b).ThenMaybe(b);
    ...
    /// <param name="s">The s.</param>
    /// <returns></returns>
    public static Maybe<int> TryParseInt(this string s) => int.TryParse(s, out var i).ThenMaybe(i);
    ...
    /// <param name="s">The s.</param>
    /// <returns></returns>
    public static Maybe<long> TryParseLong(this string s) => long.TryParse(s, out var l).ThenMaybe(l);
    ...
    /// <param name="s">The s.</param>
    /// <returns></returns>
    public static Maybe<decimal> TryParseDecimal(this string s) => decimal.TryParse(s, out var d).ThenMaybe(d);
    ...
    /// <param name="s">The s.</param>
    /// <returns></returns>
    public static Maybe<float> TryParseFloat(this string s) => float.TryParse(s, out var f).ThenMaybe(f);
    ...
    /// <param name="s">The s.</param>
    /// <returns></returns>
    public static Maybe<char> TryParseChar(this string s) => char.TryParse(s, out var c).ThenMaybe(c);
    ...
    /// <param name="s">The s.</param>
    /// <returns></returns>
    public static Maybe<double> TryParseDouble(this string s) => double.TryParse(s, out var d).ThenMaybe(d);
