...
public class ReceivingProcessingModeValidator : AbstractValidator<ReceivingProcessingMode>
{
    ...
    /// </summary>
    public ReceivingProcessingModeValidator(IValidator<Parameter> parameterValidator)
    {
    ...
    {
        static bool IsNotForwarding(ReceivingProcessingMode pmode) => pmode.MessageHandling?.ForwardInformation == null;
    ...
    private void RulesForDecryption()
    {
        ...
        {
            var encryption = pmode.Security?.Decryption?.Encryption;
