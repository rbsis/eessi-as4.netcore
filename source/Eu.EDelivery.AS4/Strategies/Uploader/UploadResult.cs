...
public class UploadResult : IEquatable<UploadResult>
{
    ...
    public virtual bool Equals(UploadResult? other)
    {
        if (other is null)
        {
            return false;
    ...
    {
        return HashCode.Combine(PayloadId, DownloadUrl, Status);
    }
    ...
    public static bool operator ==(UploadResult left, UploadResult right) => Equals(left, right);
