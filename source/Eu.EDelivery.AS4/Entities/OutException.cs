...
/// </summary>
[System.Diagnostics.CodeAnalysis.SuppressMessage("Major Code Smell", "S2166:Classes named like \"Exception\" should extend \"Exception\" or a subclass", Justification = "<Pending>")]
public class OutException : ExceptionEntity
{
    ...
    /// <summary>
    /// Sets the <see cref="ExceptionEntity.Operation"/> based on the configuration in the specified <paramref name="exceptionHandling"/>.
    /// </summary>
    ...
    {
        var needsToBeNotified = exceptionHandling?.NotifyMessageProducer == true;
        Operation = needsToBeNotified ? Operation.ToBeNotified : default;
        return this;
    }
